...
//	assign writeEn = (opcode == 5'b00000);
	...
	wire data_wren, wren_actual;
//	assign wren_actual = data_wren & (datapath_mem_address < 14'd19200);
//	assign data_wren = opcode[4]; 
	change_display_to_image datapath(
		...
		.screen_refresh_done(screen_refresh_done),
